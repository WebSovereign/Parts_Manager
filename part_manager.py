...
part_label.grid(row=0, column=0, sticky=W) # w means west e means east
...
customer_label.grid(row=0, column=2, sticky=W) # w means west e means east
...
retailer_label.grid(row=1, column=0, sticky=W) # w means west e means east
...
price_label.grid(row=1, column=2, sticky=W) # w means west e means east
...
scrollbar.configure(command=parts_list.yview) #yview = scroll along the y-axis
# Bind select
